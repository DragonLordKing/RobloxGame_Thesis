...
Name: CameraInput
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.CameraInput
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: ContextActionService, UserInputService, Players, RunService, VRService, GuiService
Requires:
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
Functions: adjustTouchPitchSensitivity, isInDynamicThumbstickArea, incPanInputCount, decPanInputCount, resetPanInputCount, thumbstick, mouseMovement, mouseWheel, keypress, gamepadZoomPress, gamepadReset, resetInputDevices, pointerAction, inputBegan, inputChanged, inputEnded, thumbstickCurve, CameraInput.getRotationActivated, CameraInput.getRotation, CameraInput.getZoomDelta, touchBegan, touchEnded, touchChanged, resetTouchState, CameraInput.setInputEnabled, CameraInput.getInputEnabled, CameraInput.resetInputForFrameEnd, CameraInput.getHoldPan, CameraInput.getTogglePan, CameraInput.getPanning, CameraInput.setTogglePan, CameraInput.enableCameraToggleInput, CameraInput.disableCameraToggleInput
Signal classes referenced: BindableEvent
Clean source lines: 565
]]
