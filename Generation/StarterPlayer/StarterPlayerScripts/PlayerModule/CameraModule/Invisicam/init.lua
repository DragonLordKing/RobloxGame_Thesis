...
Name: Invisicam
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.Invisicam
...
Functions: AssertTypes, Det3x3, RayIntersection, childAdded, childRemoved, add, Invisicam.new, Invisicam:Enable, Invisicam:GetOcclusionMode, Invisicam:LimbBehavior, Invisicam:MoveBehavior, Invisicam:CornerBehavior, Invisicam:CircleBehavior, Invisicam:LimbMoveBehavior, Invisicam:CharacterOutlineBehavior, Invisicam:SmartCircleBehavior, Invisicam:CheckTorsoReference, Invisicam:CharacterAdded, Invisicam:SetMode, Invisicam:GetObscuredParts, Invisicam:Cleanup, Invisicam:Update
Clean source lines: 597
]]
	...
	for i = 1, SMART_CIRCLE_CASTS do
		...
		if FFlagUserRaycastUpdateAPI then
			...
			if raycastResult then
				...
				local hprime = position + 0.1 * normal.unit
