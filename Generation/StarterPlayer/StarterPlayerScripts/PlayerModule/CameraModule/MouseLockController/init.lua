...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.MouseLockController
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: Players, ContextActionService, UserInputService
Requires:
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
  - local CameraUtils = require(script.Parent:WaitForChild("CameraUtils"))
Functions: MouseLockController.new, MouseLockController:GetIsMouseLocked, MouseLockController:GetBindableToggleEvent, MouseLockController:GetMouseLockOffset, MouseLockController:UpdateMouseLockAvailability, MouseLockController:OnBoundKeysObjectChanged, MouseLockController:OnMouseLockToggled, MouseLockController:DoMouseLockSwitch, MouseLockController:BindContextActions, MouseLockController:UnbindContextActions, MouseLockController:IsMouseLocked, MouseLockController:EnableMouseLock
Signal classes referenced: BindableEvent
Clean source lines: 204
]]
