...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.VehicleCamera.VehicleCameraCore
...
Functions: getYaw, getPitch, stepSpringAxis, VariableEdgeSpring.new, VariableEdgeSpring:step, YawPitchSpring.new, YawPitchSpring:setGoal, YawPitchSpring:getCFrame, YawPitchSpring:step, VehicleCameraCore.new, VehicleCameraCore:step, VehicleCameraCore:setTransform
Clean source lines: 182
]]
local CameraUtils = require(script.Parent.Parent.CameraUtils)
local VehicleCameraConfig = require(script.Parent.VehicleCameraConfig)
