...
Name: Popper
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.ZoomController.Popper
...
Functions: getTotalTransparency, eraseFromEnd, updateProjection, refreshIgnoreList, playerAdded, characterAdded, characterRemoving, playerRemoving, canOcclude, getCollisionPoint, queryPoint, queryViewport, testPromotion, Popper
Clean source lines: 446
]]
