...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.ClickToMoveDisplay
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: Players, TweenService, RunService, Workspace
Requires:
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
Functions: CreateWaypointTemplates, getTrailDotParent, placePathWaypoint, getFailureAnimationTrack, findPlayerHumanoid, createTrailDots, getTrailDotScale, removePathBeforePoint, resizeTrailDots, removePath, TrailDot:Destroy, TrailDot:NewDisplayModel, TrailDot.new, EndWaypoint:Destroy, EndWaypoint:NewDisplayModel, EndWaypoint:CreateTween, EndWaypoint:TweenInFrom, EndWaypoint.new, FailureWaypoint:Hide, FailureWaypoint:Destroy, FailureWaypoint:NewDisplayModel, FailureWaypoint:RunFailureTween, FailureWaypoint.new, ClickToMoveDisplay.CreatePathDisplay, ClickToMoveDisplay.DisplayFailureWaypoint, ClickToMoveDisplay.CreateEndWaypoint, ClickToMoveDisplay.PlayFailureAnimation, ClickToMoveDisplay.CancelFailureAnimation, ClickToMoveDisplay.SetWaypointTexture, ClickToMoveDisplay.GetWaypointTexture, ClickToMoveDisplay.SetWaypointRadius, ClickToMoveDisplay.GetWaypointRadius, ClickToMoveDisplay.SetEndWaypointTexture, ClickToMoveDisplay.GetEndWaypointTexture, ClickToMoveDisplay.SetWaypointsAlwaysOnTop, ClickToMoveDisplay.GetWaypointsAlwaysOnTop
Clean source lines: 516
]]
