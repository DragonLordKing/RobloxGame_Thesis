...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.DynamicThumbstick
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: Players, GuiService, UserInputService, ContextActionService, RunService, TweenService
Requires:
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
  - AvatarAbilitiesInterface = require(script.Parent:WaitForChild("AvatarAbilitiesInterface"))
  - local BaseCharacterController = require(script.Parent:WaitForChild("BaseCharacterController"))
Functions: inputBegan, inputChanged, inputEnded, handleInput, layoutThumbstickFrame, ResizeThumbstick, onCurrentCameraChanged, onViewportSizeChanged, longShowBackground, DynamicThumbstick.new, DynamicThumbstick:GetIsJumping, DynamicThumbstick:Enable, DynamicThumbstick:OnInputEnded, DynamicThumbstick:FadeThumbstick, DynamicThumbstick:FadeThumbstickFrame, DynamicThumbstick:InputInFrame, DynamicThumbstick:DoFadeInBackground, DynamicThumbstick:DoMove, DynamicThumbstick:LayoutMiddleImages, DynamicThumbstick:MoveStick, DynamicThumbstick:BindContextActions, DynamicThumbstick:UnbindContextActions, DynamicThumbstick:Create
Clean source lines: 633
]]
