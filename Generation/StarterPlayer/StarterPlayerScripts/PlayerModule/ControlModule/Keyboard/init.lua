...
Name: Keyboard
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.Keyboard
...
Functions: onFocusReleased, onTextFocusGained, Keyboard.new, Keyboard:Enable, Keyboard:UpdateMovement, Keyboard:UpdateJump, Keyboard:BindContextActions, Keyboard:ConnectFocusEventListeners, handleMoveForward, handleMoveBackward, handleMoveLeft, handleMoveRight, handleJumpAction
Clean source lines: 141
]]
