...
Name: TouchJump
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.TouchJump
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: Players, GuiService
Requires:
...
Functions: update, ResizeJumpButton, TouchJump.new, TouchJump:_reset, TouchJump:EnableButton, TouchJump:UpdateEnabled, TouchJump:_setupConfigurations, TouchJump:Enable, TouchJump:Create
Clean source lines: 270
]]
