...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.VehicleController
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: ContextActionService
Functions: VehicleController.new, VehicleController:BindContextActions, VehicleController:Enable, VehicleController:OnThrottleAccel, VehicleController:OnThrottleDeccel, VehicleController:OnSteerRight, VehicleController:OnSteerLeft, VehicleController:Update, VehicleController:ComputeThrottle, VehicleController:ComputeSteer, VehicleController:SetupAutoPilot
