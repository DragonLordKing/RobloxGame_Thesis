...
Name: AtomicBinding
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.RbxCharacterSounds.AtomicBinding
Exported from: Generation
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Functions: parsePath, isManifestResolved, unbindNodeDescend, processNode, processAddChild, processDeleteChild, AtomicBinding.new, AtomicBinding:_startBoundFn, AtomicBinding:_stopBoundFn, AtomicBinding:bindRoot, AtomicBinding:unbindRoot, AtomicBinding:destroy
Clean source lines: 268
]]
