...
Class: ModuleScript
Original path: game.ServerScriptService.MMO_ServerPackage.Equipment.MasterpieceQualityBlade
...
function M.ApplyStats(stats)
	...
	stats.PhysicalAttackBonus = (stats.PhysicalAttackBonus or 0) + math.floor(itemPower * 0.42)
