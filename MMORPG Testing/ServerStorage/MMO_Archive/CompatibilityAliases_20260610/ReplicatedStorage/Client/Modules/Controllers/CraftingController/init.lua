...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Controllers.CraftingController
...
target = target:WaitForChild("CraftingController")
return require(target)