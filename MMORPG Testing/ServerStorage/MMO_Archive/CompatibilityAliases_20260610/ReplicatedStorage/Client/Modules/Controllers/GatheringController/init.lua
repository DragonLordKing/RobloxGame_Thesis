...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Controllers.GatheringController
...
target = target:WaitForChild("GatheringController")
return require(target)