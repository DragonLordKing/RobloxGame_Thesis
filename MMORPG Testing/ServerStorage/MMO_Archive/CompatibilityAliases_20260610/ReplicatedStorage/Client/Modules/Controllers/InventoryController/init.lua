...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Controllers.InventoryController
...
target = target:WaitForChild("InventoryController")
return require(target)