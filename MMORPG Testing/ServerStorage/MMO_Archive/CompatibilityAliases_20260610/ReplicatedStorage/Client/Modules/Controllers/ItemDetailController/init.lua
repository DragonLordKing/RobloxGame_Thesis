...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Controllers.ItemDetailController
...
target = target:WaitForChild("ItemDetailController")
return require(target)