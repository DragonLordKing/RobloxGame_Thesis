...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Controllers.OcclusionController
...
target = target:WaitForChild("OcclusionController")
return require(target)