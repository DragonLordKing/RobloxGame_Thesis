...
Name: CollisionUtil
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.CollisionUtil
...
target = target:WaitForChild("CollisionUtil")
return require(target)