...
Name: Config
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.Config
...
target = target:WaitForChild("Config")
return require(target)