...
Name: Effects
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.Effects
...
target = target:WaitForChild("Effects")
return require(target)