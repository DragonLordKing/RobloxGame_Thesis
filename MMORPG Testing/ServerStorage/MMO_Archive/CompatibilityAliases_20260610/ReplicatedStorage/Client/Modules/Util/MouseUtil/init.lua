...
Name: MouseUtil
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.MouseUtil
...
target = target:WaitForChild("MouseUtil")
return require(target)