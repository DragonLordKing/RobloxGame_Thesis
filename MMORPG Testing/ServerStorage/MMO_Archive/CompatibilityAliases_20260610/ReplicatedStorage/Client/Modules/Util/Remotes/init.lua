...
Name: Remotes
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.Remotes
...
target = target:WaitForChild("Remotes")
return require(target)