...
Name: Selection
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Client.Modules.Util.Selection
...
target = target:WaitForChild("Selection")
return require(target)