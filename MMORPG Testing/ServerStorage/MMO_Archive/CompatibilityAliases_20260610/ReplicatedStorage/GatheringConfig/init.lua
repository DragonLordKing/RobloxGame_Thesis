...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.GatheringConfig
...
target = target:WaitForChild("GatheringConfig")
return require(target)