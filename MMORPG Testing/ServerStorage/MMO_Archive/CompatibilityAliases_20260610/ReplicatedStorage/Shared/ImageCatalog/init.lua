...
Name: ImageCatalog
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Shared.ImageCatalog
...
target = target:WaitForChild("ImageCatalog")
return require(target)