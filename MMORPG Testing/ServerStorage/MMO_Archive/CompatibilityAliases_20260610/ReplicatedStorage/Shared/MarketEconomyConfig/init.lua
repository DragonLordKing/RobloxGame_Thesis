...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Shared.MarketEconomyConfig
...
target = target:WaitForChild("MarketEconomyConfig")
return require(target)