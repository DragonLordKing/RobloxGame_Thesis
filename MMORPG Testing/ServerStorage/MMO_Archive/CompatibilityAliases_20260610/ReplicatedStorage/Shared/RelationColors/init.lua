...
Name: RelationColors
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ReplicatedStorage.Shared.RelationColors
...
target = target:WaitForChild("RelationColors")
return require(target)