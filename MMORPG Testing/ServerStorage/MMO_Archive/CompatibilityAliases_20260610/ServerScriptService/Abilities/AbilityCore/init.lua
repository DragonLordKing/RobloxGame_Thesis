...
Name: AbilityCore
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Abilities.AbilityCore
...
target = target:WaitForChild("AbilityCore")
return require(target)