...
Name: LineStrike
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Abilities.Sword.LineStrike
...
target = target:WaitForChild("LineStrike")
return require(target)