...
Name: PiercingThrust
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Abilities.Sword.PiercingThrust
...
target = target:WaitForChild("PiercingThrust")
return require(target)