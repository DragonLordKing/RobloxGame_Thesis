...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.AbilityRegistry
...
target = target:WaitForChild("AbilityRegistry")
return require(target)