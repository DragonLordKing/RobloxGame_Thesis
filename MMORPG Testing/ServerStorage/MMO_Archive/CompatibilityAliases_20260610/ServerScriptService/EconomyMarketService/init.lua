...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.EconomyMarketService
...
target = target:WaitForChild("EconomyMarketService")
return require(target)