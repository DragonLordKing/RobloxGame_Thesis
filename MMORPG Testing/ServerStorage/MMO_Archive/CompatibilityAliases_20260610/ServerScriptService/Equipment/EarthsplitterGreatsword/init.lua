...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.EarthsplitterGreatsword
...
target = target:WaitForChild("EarthsplitterGreatsword")
return require(target)