...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.GuardianLongsword
...
target = target:WaitForChild("GuardianLongsword")
return require(target)