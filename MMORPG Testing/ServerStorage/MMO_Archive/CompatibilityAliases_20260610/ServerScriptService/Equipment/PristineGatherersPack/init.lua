...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.PristineGatherersPack
...
target = target:WaitForChild("PristineGatherersPack")
return require(target)