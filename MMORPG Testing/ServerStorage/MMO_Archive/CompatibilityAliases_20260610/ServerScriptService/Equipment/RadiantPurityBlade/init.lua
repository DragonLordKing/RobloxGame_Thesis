...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.RadiantPurityBlade
...
target = target:WaitForChild("RadiantPurityBlade")
return require(target)