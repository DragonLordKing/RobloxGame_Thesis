...
Name: TestSword
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.TestSword
...
target = target:WaitForChild("TestSword")
return require(target)