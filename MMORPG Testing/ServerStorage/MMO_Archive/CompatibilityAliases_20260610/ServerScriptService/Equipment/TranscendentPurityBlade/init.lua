...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.Equipment.TranscendentPurityBlade
...
target = target:WaitForChild("TranscendentPurityBlade")
return require(target)