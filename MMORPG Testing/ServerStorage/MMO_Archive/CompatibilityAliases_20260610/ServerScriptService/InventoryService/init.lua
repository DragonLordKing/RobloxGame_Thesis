...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.InventoryService
...
target = target:WaitForChild("InventoryService")
return require(target)