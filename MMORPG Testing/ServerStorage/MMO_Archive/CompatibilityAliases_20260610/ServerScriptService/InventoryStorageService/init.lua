...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.InventoryStorageService
...
target = target:WaitForChild("InventoryStorageService")
return require(target)