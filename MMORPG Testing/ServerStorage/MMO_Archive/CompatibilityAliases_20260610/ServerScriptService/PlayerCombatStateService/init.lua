...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.PlayerCombatStateService
...
target = target:WaitForChild("PlayerCombatStateService")
return require(target)