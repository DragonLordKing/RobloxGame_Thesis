...
Name: Bootstrap
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.PlayerCoreLean.Bootstrap
...
target = target:WaitForChild("Bootstrap")
return require(target)