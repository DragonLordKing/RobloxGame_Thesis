...
Name: Heartbeat
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.PlayerCoreLean.Heartbeat
...
target = target:WaitForChild("Heartbeat")
return require(target)