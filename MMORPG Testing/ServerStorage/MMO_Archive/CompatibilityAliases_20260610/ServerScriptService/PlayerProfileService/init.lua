...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.PlayerProfileService
...
target = target:WaitForChild("PlayerProfileService")
return require(target)