...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.RelationshipService
...
target = target:WaitForChild("RelationshipService")
return require(target)