...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.WorldRuntime.SmartChestService
...
target = target:WaitForChild("SmartChestService")
return require(target)