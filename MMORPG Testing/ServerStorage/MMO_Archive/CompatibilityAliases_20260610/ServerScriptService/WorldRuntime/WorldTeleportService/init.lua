...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerScriptService.WorldRuntime.WorldTeleportService
...
target = target:WaitForChild("WorldTeleportService")
return require(target)