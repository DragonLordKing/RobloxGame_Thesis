...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerStorage.StatsSidebarInstaller
...
target = target:WaitForChild("StatsSidebarInstaller")
return require(target)