...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerStorage.WorldTemplate.PackageManifest
...
target = target:WaitForChild("PackageManifest")
return require(target)