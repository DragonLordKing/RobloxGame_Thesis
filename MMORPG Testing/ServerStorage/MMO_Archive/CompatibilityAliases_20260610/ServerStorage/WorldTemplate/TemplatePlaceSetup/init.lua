...
Class: ModuleScript
Original path: game.ServerStorage.MMO_Archive.CompatibilityAliases_20260610.ServerStorage.WorldTemplate.TemplatePlaceSetup
...
target = target:WaitForChild("TemplatePlaceSetup")
return require(target)