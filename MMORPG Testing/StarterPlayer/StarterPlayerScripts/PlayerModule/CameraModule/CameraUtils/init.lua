...
Name: CameraUtils
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.CameraUtils
Exported from: MMORPG Testing
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: Players, UserInputService
Functions: round, SCurveTranform, toSCurveSpace, fromSCurveSpace, onAxis, getMouse, Spring.new, Spring:step, CameraUtils.map, CameraUtils.mapClamp, CameraUtils.getLooseBoundingSphere, CameraUtils.sanitizeAngle, CameraUtils.Round, CameraUtils.IsFinite, CameraUtils.IsFiniteVector3, CameraUtils.GetAngleBetweenXZVectors, CameraUtils.RotateVectorByAngleAndRound, CameraUtils.GamepadLinearToCurve, CameraUtils.ConvertCameraModeEnumToStandard, CameraUtils.setMouseIconOverride, CameraUtils.restoreMouseIcon, CameraUtils.setMouseBehaviorOverride, CameraUtils.restoreMouseBehavior, CameraUtils.setRotationTypeOverride, CameraUtils.restoreRotationType
Clean source lines: 303
]]
