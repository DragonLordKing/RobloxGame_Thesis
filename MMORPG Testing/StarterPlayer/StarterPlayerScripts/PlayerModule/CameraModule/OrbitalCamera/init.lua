...
Name: OrbitalCamera
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.OrbitalCamera
...
Functions: OrbitalCamera.new, OrbitalCamera:LoadOrCreateNumberValueParameter, OrbitalCamera:SetAndBoundsCheckAzimuthValues, OrbitalCamera:SetAndBoundsCheckElevationValues, OrbitalCamera:SetAndBoundsCheckDistanceValues, OrbitalCamera:LoadNumberValueParameters, OrbitalCamera:GetModuleName, OrbitalCamera:SetInitialOrientation, OrbitalCamera:GetCameraToSubjectDistance, OrbitalCamera:SetCameraToSubjectDistance, OrbitalCamera:CalculateNewLookVector, OrbitalCamera:Update
Clean source lines: 276
]]
