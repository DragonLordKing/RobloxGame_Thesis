...
Name: Poppercam
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.Poppercam
...
Functions: cframeToAxis, axisToCFrame, extractRotation, extrapolate, TransformExtrapolator.new, TransformExtrapolator:Step, TransformExtrapolator:Reset, Poppercam.new, Poppercam:GetOcclusionMode, Poppercam:Enable, Poppercam:Update, Poppercam:CharacterAdded, Poppercam:CharacterRemoving, Poppercam:OnCameraSubjectChanged
Clean source lines: 122
]]
