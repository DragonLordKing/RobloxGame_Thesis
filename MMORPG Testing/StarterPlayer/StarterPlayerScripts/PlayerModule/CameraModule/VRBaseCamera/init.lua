...
Name: VRBaseCamera
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.VRBaseCamera
Exported from: MMORPG Testing
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: VRService, Players, Lighting, RunService
Requires:
  - local CameraInput = require(script.Parent:WaitForChild("CameraInput"))
  - local ZoomController = require(script.Parent:WaitForChild("ZoomController"))
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
  - local BaseCamera = require(script.Parent:WaitForChild("BaseCamera"))
Functions: VRBaseCamera.new, VRBaseCamera:Reset, VRBaseCamera:GetModuleName, VRBaseCamera:GamepadZoomPress, VRBaseCamera:GamepadReset, VRBaseCamera:ResetZoom, VRBaseCamera:OnEnabledChanged, VRBaseCamera:OnCurrentCameraChanged, VRBaseCamera:OnHeadScaleChanged, VRBaseCamera:GetVRFocus, VRBaseCamera:StartFadeFromBlack, VRBaseCamera:UpdateFadeFromBlack, VRBaseCamera:StartVREdgeBlur, VRBaseCamera:UpdateEdgeBlur, VRBaseCamera:GetCameraHeight, VRBaseCamera:GetSubjectCFrame, VRBaseCamera:GetSubjectPosition, VRBaseCamera:getRotation
Clean source lines: 415
]]
