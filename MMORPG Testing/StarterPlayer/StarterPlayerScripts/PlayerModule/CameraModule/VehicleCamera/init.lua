...
Name: VehicleCamera
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.VehicleCamera
Exported from: MMORPG Testing
Original comments: removed
Children: 2
Properties: Archivable=false, LinkedSource=""
Services: Players, RunService
Requires:
...
Functions: pitchVelocity, yawVelocity, VehicleCamera.new, VehicleCamera:Reset, VehicleCamera:_StepRotation, VehicleCamera:_GetThirdPersonLocalOffset, VehicleCamera:_GetFirstPersonLocalOffset, VehicleCamera:Update, VehicleCamera:ApplyVRTransform
Clean source lines: 214
]]
