...
Name: CameraWrapper
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.CommonUtils.CameraWrapper
...
Functions: CameraWrapper.new, CameraWrapper:_connectCallbacks, CameraWrapper:Enable, CameraWrapper:Disable, CameraWrapper:Connect, CameraWrapper:Disconnect, CameraWrapper:getCamera
Clean source lines: 113
]]
local ConnectionUtil = require(script.Parent.ConnectionUtil)
