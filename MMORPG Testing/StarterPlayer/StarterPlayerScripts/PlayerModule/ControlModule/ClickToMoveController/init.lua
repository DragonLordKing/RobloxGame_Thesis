...
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.ClickToMoveController
Exported from: MMORPG Testing
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: UserInputService, PathfindingService, Players, Debris, StarterGui, Workspace, CollectionService, GuiService
Requires:
...
Functions: FindCharacterAncestor, Raycast, findPlayerHumanoid, GetCharacter, UpdateIgnoreTag, getIgnoreList, minV, maxV, getCollidableExtentsSize, Pather, CheckAlive, GetEquippedTool, CleanupPath, HandleMoveTo, ShowPathFailedFeedback, DisconnectEvent, OnCharacterChildAdded, this:Cleanup, this:Cancel, this:IsActive, this:OnPathInterrupted, this:ComputePath, this:IsValidPath, this:OnPathBlocked, this:OnRenderStepped, this:IsCurrentWaypointReached, this:OnPointReached, this:MoveToNextWayPoint, this:Start, OnTap, ClickToMove.new, ClickToMove:DisconnectEvents, ClickToMove:OnTouchBegan, ClickToMove:OnTouchChanged, ClickToMove:OnTouchEnded, ClickToMove:OnPreferredInputChanged, ClickToMove:OnCharacterAdded, ClickToMove:Start, ClickToMove:Stop, ClickToMove:CleanupPath, ClickToMove:Enable, ClickToMove:OnRenderStepped, ClickToMove:UpdateMovement, ClickToMove:UpdateJump, ClickToMove:SetShowPath, ClickToMove:GetShowPath, ClickToMove:SetWaypointTexture, ClickToMove:GetWaypointTexture, ClickToMove:SetWaypointRadius, ClickToMove:GetWaypointRadius, ClickToMove:SetEndWaypointTexture, ClickToMove:GetEndWaypointTexture, ClickToMove:SetWaypointsAlwaysOnTop, ClickToMove:GetWaypointsAlwaysOnTop, ClickToMove:SetFailureAnimationEnabled, ClickToMove:GetFailureAnimationEnabled, ClickToMove:SetIgnoredPartsTag, ClickToMove:GetIgnoredPartsTag, ClickToMove:SetUseDirectPath, ClickToMove:GetUseDirectPath
Signal classes referenced: BindableEvent
Clean source lines: 1224
]]
