...
Name: VRNavigation
Class: ModuleScript
Original path: game.StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.VRNavigation
Exported from: MMORPG Testing
Original comments: removed
Children: 0
Properties: Archivable=false, LinkedSource=""
Services: VRService, UserInputService, RunService, Players, PathfindingService, ContextActionService, StarterGui
Requires:
  - local FlagUtil = require(CommonUtils:WaitForChild("FlagUtil"))
  - PathDisplay = require(PathDisplayModule)
  - local BaseCharacterController = require(script.Parent:WaitForChild("BaseCharacterController"))
Functions: IsFinite, IsFiniteVector3, VRNavigation.new, VRNavigation:SetLaserPointerMode, VRNavigation:GetLocalHumanoid, VRNavigation:HasBothHandControllers, VRNavigation:HasAnyHandControllers, VRNavigation:IsMobileVR, VRNavigation:HasGamepad, VRNavigation:ShouldUseNavigationLaser, VRNavigation:StartFollowingPath, VRNavigation:GoToPoint, VRNavigation:StopFollowingPath, VRNavigation:TryComputePath, VRNavigation:OnNavigationRequest, VRNavigation:OnJumpAction, VRNavigation:BindJumpAction, VRNavigation:ControlCharacterGamepad, VRNavigation:OnHeartbeat, VRNavigation:OnUserCFrameEnabled, VRNavigation:Enable
Signal classes referenced: BindableEvent
Clean source lines: 470
]]
