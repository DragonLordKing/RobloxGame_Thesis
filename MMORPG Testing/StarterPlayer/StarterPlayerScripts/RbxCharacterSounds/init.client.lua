...
Class: LocalScript
Original path: game.StarterPlayer.StarterPlayerScripts.RbxCharacterSounds
Exported from: MMORPG Testing
Original comments: removed
Children: 1
Properties: Enabled=true, LinkedSource="", Disabled=false, RunContext="Enum.RunContext.Legacy", Archivable=false
Services: Players, RunService, SoundService
Requires:
  - local AtomicBinding = require(script:WaitForChild("AtomicBinding"))
Functions: loadFlag, map, getRelativeVelocity, playSound, stopSound, playSoundIf, setSoundLooped, shallowCopy, initializeSoundSystem, stopPlayingLoopedSounds, transitionTo, terminate, characterAdded, characterRemoving, playerAdded, playerRemoving
